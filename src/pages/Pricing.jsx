        ...
        <div class="mx-auto mt-8 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-12 lg:mx-0 lg:flex lg:max-w-none">
          <div class="p-8 sm:p-10 lg:flex-auto">
            ...
            <div class="mt-10 flex items-center gap-x-4">
              <h4 class="flex-none text-sm font-semibold leading-6 text-greenBtn">
                What’s included
              </h4>
            ...
            >
              <li class="flex gap-x-3">
                <svg
                  class="h-6 w-5 flex-none text-greenBtn"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                  aria-hidden="true"
                >
          ...
          <div class="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
            <div class="rounded-2xl bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
              <div class="mx-auto max-w-xs px-8">
                ...
                <a
                  href="#"
                  class="mt-10 block w-full rounded-md bg-greenBtn px-3 py-2 text-center text-sm font-semibold text-white hover:bg-greenBtnHover"
                >
                  Get access
                </a>
