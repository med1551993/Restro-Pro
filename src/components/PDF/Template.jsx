...
function PdfTemplate({ invoices }) {
  ...
  return (
    <>
      ...
      >
        <div className="bg-white w-[50rem] px-10 py-16" ref={ref}>
                ...
                <div className="flex flex-col justify-center gap-24">
                  ...
                  <div className="">
                    <table className="w-full">
                      <thead className="p-2">
                        <tr className="border-b-[1px] *:text-start">
                          <th>
                        ...
                        <tr className="border-t-[1px]  border-b-[1px] *:py-2">
                          ...
                          <td>
                            <p>
                              <strong>
                                $
                                {invoice.data.reduce((cartTotal, cartItem) => {
                                  return (cartTotal =
        ...
        <div className="flex flex-row gap-2 items-center justify-end w-[50rem]">
          <button
            onClick={() => navigate(-1)}
